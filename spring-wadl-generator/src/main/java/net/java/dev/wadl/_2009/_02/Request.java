...
public class Request {
     ...
     * 
     */
    public Request(final List<Doc> doc, final List<Param> param, final List<Representation> representation, final List<Object> any, final Map<QName, String> otherAttributes) {
        this.doc = doc;
        this.param = param;
    ...
    public Request withDoc(Doc... values) {
        if (values!= null) {
    ...
    public Request withDoc(Collection<Doc> values) {
        if (values!= null) {
    ...
    public Request withParam(Param... values) {
        if (values!= null) {
    ...
    public Request withParam(Collection<Param> values) {
        if (values!= null) {
    ...
    public Request withRepresentation(Representation... values) {
        if (values!= null) {
    ...
    public Request withRepresentation(Collection<Representation> values) {
        if (values!= null) {
    ...
    public Request withAny(Object... values) {
        if (values!= null) {
    ...
    public Request withAny(Collection<Object> values) {
        if (values!= null) {
