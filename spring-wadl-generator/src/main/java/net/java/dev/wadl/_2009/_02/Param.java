...
public class Param {
     ...
     * 
     */
    public Param(final List<Doc> doc, final List<Option> option, final Link link, final List<Object> any, final String href, final String name, final ParamStyle style, final String id, final QName type, final String _default, final Boolean required, final Boolean repeating, final String fixed, final String path, final Map<QName, String> otherAttributes) {
        this.doc = doc;
        this.option = option;
        this.link = link;
        this.any = any;
