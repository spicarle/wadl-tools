...
public class ResourceType {
     ...
     * 
     */
    public ResourceType(final List<Doc> doc, final List<Param> param, final List<Object> methodOrResource, final List<Object> any, final String id, final Map<QName, String> otherAttributes) {
        this.doc = doc;
        this.param = param;
    ...
    public ResourceType withMethodOrResource(Object... values) {
        if (values!= null) {
    ...
    public ResourceType withMethodOrResource(Collection<Object> values) {
        if (values!= null) {
